...
export const vegetarischeGerichte: readonly MenuItem[] = [
  { id: 519, number: 19, name: "Zigaretten Börek", description: "knusprige Börek-Röllchen, gefüllt mit Käse", price: 1.00 },
  { id: 520, number: 20, name: "Halloumi-Tasche", description: "im Fladenbrot mit gegrilltem Halloumi, frischem Salat & Soße", price: 7.00, isSpezialitaet: true },
  { id: 521, number: 21, name: "Halloumi-Dürüm", description: "im dünnen Fladenbrot mit gegrilltem Halloumi, frischem Salat & Soße", price: 8.00, isSpezialitaet: true },
  { id: 522, number: 22, name: "Halloumi-Teller", description: "mit gegrilltem Halloumi, Bulgur oder Pommes, Salat & Soße", price: 13.50, isSpezialitaet: true },
  { id: 523, number: 23, name: "Falafel-Tasche", description: "im Fladenbrot mit hausgemachten Falafel, gemischtem Salat & Soße", price: 7.00, isSpezialitaet: true },
  { id: 524, number: 24, name: "Falafel-Dürüm", description: "im dünnen Fladenbrot mit Falafel, gemischtem Salat & Soße", price: 8.00, isSpezialitaet: true },
  { id: 525, number: 25, name: "Falafel-Teller", description: "mit Bulgur oder Pommes frites, gemischtem Salat & Soße", price: 13.50, isSpezialitaet: true }
];
...
export const croques: readonly MenuItem[] = [
  ...
  { id: 549, number: 49, name: "Salami Croque", description: "mit Salami", price: 8.50 },
...
export const fleischgerichte: readonly MenuItem[] = [
  { id: 529, number: 1, name: "Drehspieß Tasche", description: "mit Drehspieß nach Wahl: Kalb oder Hähnchen im Fladenbrot, gemischtem Salat & Soße", price: 7.50, isSpezialitaet: true, isMeatSelection: true },
  { id: 530, number: 2, name: "Drehspieß Dürüm", description: "mit Drehspieß nach Wahl: Kalb oder Hähnchen, gemischtem Salat & Soße", price: 8.50, isSpezialitaet: true, isMeatSelection: true },
  { id: 531, number: 3, name: "Drehspieß Box", description: "mit Drehspieß nach Wahl: Kalb oder Hähnchen, Pommes frites & Soße", price: 7.50, isSpezialitaet: true, isMeatSelection: true },
  { id: 532, number: 4, name: "Drehspieß Teller (mit Pommes)", description: "mit Drehspieß nach Wahl: Kalb oder Hähnchen, Pommes frites oder Bulgur & Soße", price: 13.50, isSpezialitaet: true, isMeatSelection: true },
  { id: 533, number: 5, name: "Drehspieß (mit Salat)", description: "mit Drehspieß nach Wahl: Kalb oder Hähnchen, Salat & Soße", price: 13.50, isSpezialitaet: true, isMeatSelection: true },
  ...
  { id: 537, number: 9, name: "Lahmacun Kalb oder Hähnchen", description: "Drehspieß nach Wahl: Kalb oder Hähnchen mit gemischtem Salat & Soße", price: 7.00, isSpezialitaet: true, isMeatSelection: true },
...
export const pizzas: readonly MenuItem[] = [
  ...
  { id: 527, number: 27, name: "Pizza Salami", description: "mit Salami", price: 10.00, isPizza: true },
  ...
  { id: 541, number: 41, name: "Pizza Rustica", description: "mit Schinken, Salami & frischen Champignons", price: 11.00, isPizza: true },
  ...
  { id: 544, number: 44, name: "Pizza Quattro Stagioni", description: "mit Schinken, Salami, Champignons & Artischocken", price: 12.00, isPizza: true },
  { id: 545, number: 45, name: "Pizza India", description: "mit Schinken, Hähnchenbrustfilet, Ananas & Currysauce", price: 12.00, isPizza: true },
  { id: 546, number: 46, name: "Pizza Diavolo", description: "mit Salami, Champignons & Peperoni", price: 12.50, isPizza: true },

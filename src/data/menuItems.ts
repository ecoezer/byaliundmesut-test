...
export const croques: readonly MenuItem[] = [
  ...
  { id: 561, number: 61, name: "Drehspieß Croque", description: "mit Drehspieß nach Wahl: Kalb oder Hähnchen", price: 9.00, isMeatSelection: true, allergens: "A1, 1, G, 4, 9, 3, 9, 12, 18" }
];
...
export const fleischgerichte: readonly MenuItem[] = [
  ...
  { id: 535, number: 7, name: "Sucuk Teller", description: "mit türkischer Knoblauchwurst mit Bulgur oder Pommes, mit gemischtem Salat & Soße", price: 13.50, isSpezialitaet: true, isMultipleSauceSelection: true, hasSideDishSelection: true, allergens: "A1, G, 1a, 4, 9, 12, 18" },
